...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="font-size: 16px; line-height: 1.8;">
        This is a notification that <strong>${revocation.athleteName}</strong> has removed your access to the following shared folder:
      </p>

      <div class="folder-name">
        <strong>"${revocation.folderName}"</strong>
      </div>
      ...
      <div class="notice">
        <p>
          <strong>Note:</strong> If you believe this was done in error, please contact ${revocation.athleteName} directly.
        </p>
      </div>

      <p style="font-size: 13px; color: #999; margin-top: 32px; padding-top: 24px; border-top: 1px solid #eee;">
        This notification was sent to ${revocation.coachEmail}.
      </p>
    </div>
