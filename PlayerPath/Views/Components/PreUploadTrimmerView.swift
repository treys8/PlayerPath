//
//  PreUploadTrimmerView.swift
//  PlayerPath
//
//  Optional trim step shown before saving a freshly-recorded or re-trimmed
//  video. Used by DirectCameraRecorderView, CoachVideoUploadView, and
//  RetrimSavedClipFlow. Imports from the photo library skip this view — see
//  BulkVideoImportViewModel.
//
...
struct PreUploadTrimmerView: View {
    ...
    private func setupPlayer() {
        ...
        // Store the task so cleanup() can cancel it if the view is dismissed
    ...
    private func cleanup() {
        // Cancel the duration-loading task before tearing down the player.
        durationTask?.cancel()
        durationTask = nil
