            ...
            for game in athlete.games ?? [] {
                if let gs = game.gameStats {
                    allGameStats.append([
                        ...
                        "inningsPitched": gs.inningsPitchedDisplay,
                        "earnedRuns": gs.earnedRuns,
                        "runsAllowed": gs.runsAllowed,
                        "hitsAllowed": gs.hitsAllowed,
                        "homeRunsAllowed": gs.homeRunsAllowed,
                        "battersFaced": gs.battersFaced,
                        "hasManualEntry": gs.hasManualEntry
                    ])
                }
            }
        }
