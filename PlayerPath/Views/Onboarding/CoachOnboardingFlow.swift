        ...
        ZStack(alignment: .bottom) {
            ...
            HStack(spacing: 8) {
                ForEach(0..<totalPages, id: \.self) { index in
                    Capsule()
                        .fill(index == currentPage ? ppAccent : ppAccent.opacity(0.3))
        ...
        VStack(spacing: 0) {
                ...
                ZStack {
                    ...
                    ZStack {
                        Circle()
                            .fill(
                                LinearGradient(
                                    colors: [ppAccent.opacity(0.25), ppAccent.opacity(0.15)],
                            ...
                            .overlay(
                                Circle()
                                    .stroke(ppAccent.opacity(0.4), lineWidth: 1)
                            )
                ...
                HStack(spacing: 14) {
                    Image(systemName: "person.fill.checkmark")
                        ...
                        .background(ppAccent.opacity(0.15))
                        .clipShape(Circle())
